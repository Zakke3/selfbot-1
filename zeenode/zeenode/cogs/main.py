...
class Main(zeenode.Cog):
    ...
    async def help(self, ctx, category=None):
        ...
        if category is None:
            ...
            embed.set_author(name="Iain's Self-Bot | Prefix: " + str(bot.command_prefix),
                            icon_url="https://cdn.discordapp.com/icons/891717404223229972/8ca7701f0ca8406f9349099c7dbea3b2.png?size=4096")
            embed.set_image(url="")
